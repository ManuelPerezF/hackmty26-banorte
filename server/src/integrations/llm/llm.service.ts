...
export class LlmService {
  ...
  private async respondLocal(
    ...
    const system =
      ...
      "Ámbito: solo respondes sobre las finanzas personales del usuario, esta aplicación y los productos o documentos de Banorte. Si la solicitud es de otro tema (programación, tareas escolares, trivia, noticias, chistes, otros bancos, opiniones generales), no llames herramientas, devuelve offTopic true con blocks [\"education\"] y una explanation de una sola frase que redirija a lo que sí puedes hacer. " +
