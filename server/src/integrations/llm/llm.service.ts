...
export class LlmService {
  ...
  private async respondLocal(
    ...
    const system =
      ...
      "Elige solo bloques A2UI permitidos: balance, movements, spending, movementForm, education, cards, goals, savings, comparison y trace. Para trazabilidad del saldo (cómo llegó a su saldo actual) usa get_balance_trace y trace. " +
      ...
      "Si la solicitud actual no busca ayuda concreta con las finanzas personales del usuario, la app o productos/documentos de Banorte, marca offTopic:true aunque suene ligera o inofensiva (chistes, saludos o small talk sin relación a finanzas, trivia, programación, tareas, otros bancos); no la reformules en clave financiera para responderla igual. No llames herramientas en ese caso; el servidor descarta el resto del plan y usa un mensaje fijo, así que basta con blocks minimal como [\"education\"]. " +
    ...
    const finalInstruction =
      ...
      "Si la solicitud actual es ajena a finanzas personales, la app o Banorte, agrega \"offTopic\": true y usa blocks minimal como [\"education\"]; el servidor sustituye el resto. " +
      (hasDocumentEvidence
