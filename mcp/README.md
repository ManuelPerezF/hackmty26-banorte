...
`server.ts` implementa diez herramientas del proyecto mediante el SDK oficial y transporte stdio. Nest lo inicia automáticamente por turno con una capacidad breve de autorización; no necesita un puerto ni un contenedor propios.
